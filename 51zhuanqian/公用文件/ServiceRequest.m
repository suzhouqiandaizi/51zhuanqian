...
- (void)RequestMethod:(NSString *)method withURL:(NSString *)urlStr parameters:(id)parameters success:(void (^)(id))success failure:(void (^)(NSString *, NSInteger code))failure{
    ...
    [request setValue:user.phone forHTTPHeaderField:@"mobile"];
    [request setValue:user.userID forHTTPHeaderField:@"platformId"];
    [request setValue:[[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleShortVersionString"] forHTTPHeaderField:@"Version"];
    [request setValue:@"51zhuanqian" forHTTPHeaderField:@"appName"];
...
- (void)GETLogin:(NSString *)URLString parameters:(id)parameters success:(void (^)(id))success failure:(void (^)(NSString *, NSInteger code))failure {
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@", HOSTIP, URLString]]];
    [request setTimeoutInterval:TIMEOUT];
    [request setHTTPMethod:@"GET"];
    //配置用户名 密码
    NSString * str1 = [NSString stringWithFormat:@"%@:%@",[parameters objectForKey:@"mobileNumber"],[parameters objectForKey:@"password"]];
    //进行加密  [str base64EncodedString]使用开源Base64.h分类文件加密
    NSString * str2 = [NSString stringWithFormat:@"Basic %@",[str1 base64EncodedString]];
...
//    [request setHTTPBody: [str dataUsingEncoding:NSUTF8StringEncoding]];
    ...
    [dataTask resume];
    [NSString stringWithFormat:@"%@%@", HOSTIP, [NSString stringWithFormat:@"%@%@", HOSTIP, URLString]];
}
