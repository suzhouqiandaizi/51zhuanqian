...
- (void)setupViews {
    ...
    bezelView.alpha = 1.f;
    bezelView.color = [UIColor blackColor];
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _progress = 0.f;
        _annular = NO;
        _progressTintColor = [UIColor whiteColor];//[[UIColor alloc] initWithWhite:1.f alpha:1.f];
        _backgroundTintColor = [UIColor redColor];//[[UIColor alloc] initWithWhite:1.f alpha:.1f];
    }
    return self;
}
