...
@interface BWRZQFaBuFillInBuZhouTypeAlertView()
...
@end
@implementation BWRZQFaBuFillInBuZhouTypeAlertView
- (id)initItem{
    self = [[[NSBundle mainBundle] loadNibNamed:@"BWRZQFaBuFillInBuZhouTypeAlertView" owner:self options:nil] lastObject];
    if (self) {
