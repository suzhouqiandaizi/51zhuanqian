...
@interface WYZQTaskDoingItemViewController (){
...
@end
@implementation WYZQTaskDoingItemViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    pageNum = 1;
    pageSize = 15;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    WYZQTaskDoingItemTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"WYZQTaskDoingItemTableViewCell" owner:self options:nil] lastObject];
    ...
    cell.chakan = ^(NSInteger index) {
        WYZQTaskDoingDetailViewController *viewCon = [[WYZQTaskDoingDetailViewController alloc] initWithNibName:@"WYZQTaskDoingDetailViewController" bundle:nil];
