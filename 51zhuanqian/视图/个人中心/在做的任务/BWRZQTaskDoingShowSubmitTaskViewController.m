...
@interface BWRZQTaskDoingShowSubmitTaskViewController ()<UploadImageViewDelegate, UIScrollViewDelegate, MIPhotoBrowserDelegate>{
...
@end
@implementation BWRZQTaskDoingShowSubmitTaskViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"提交的任务结果";
    [self addBackBtn];
