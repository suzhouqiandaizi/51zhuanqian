...
@interface WYZQTaskDoingDetailProcessViewController ()
@property (weak, nonatomic) IBOutlet UIScrollView *scrollView;
@property (nonatomic, strong) LXGradientProcessView *processView;
@end
@implementation WYZQTaskDoingDetailProcessViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)showSumbitPress{
    WYZQTaskDoingShowSubmitTaskViewController *viewCon = [[WYZQTaskDoingShowSubmitTaskViewController alloc] initWithNibName:@"WYZQTaskDoingShowSubmitTaskViewController" bundle:nil];
