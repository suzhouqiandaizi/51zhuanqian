...
@interface BWRZQTaskDoingDetailViewController ()<SGPageTitleViewDelegate, SGPageContentViewDelegate>{
    BWRZQTaskObject *taskObject;
    BWRZQTaskDoingDetailTwoContentViewController *viewCon1;
}
...
@end
@implementation BWRZQTaskDoingDetailViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"任务详情";
    [self addBackBtn];
...
- (IBAction)shensuPress {
    BWRZQAppealViewController *viewCon = [[BWRZQAppealViewController alloc] initWithNibName:@"BWRZQAppealViewController" bundle:nil];
...
- (void)setupPageView{
    ...
    viewCon1 = [[BWRZQTaskDoingDetailTwoContentViewController alloc] initWithNibName:@"BWRZQTaskDoingDetailTwoContentViewController" bundle:nil];
    [viewConMutArr addObject:viewCon1];
    [titleMutArr addObject:@"任务详情"];
    BWRZQTaskDoingDetailProcessViewController *viewCon2 = [[BWRZQTaskDoingDetailProcessViewController alloc] initWithNibName:@"BWRZQTaskDoingDetailProcessViewController" bundle:nil];
