...
@interface WYZQTaskDoingViewController ()<SGPageTitleViewDelegate, SGPageContentViewDelegate>
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentView *pageContentView;
@end
@implementation WYZQTaskDoingViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"我在做的任务";
    [self addBackBtn];
...
- (void)setupPageView {
    ...
    for (NSInteger i = 0; i < arrayID.count ; i++) {
        WYZQTaskDoingItemViewController *viewCon = [[WYZQTaskDoingItemViewController alloc] initWithNibName:@"WYZQTaskDoingItemViewController" bundle:nil];
        viewCon.type = i;
