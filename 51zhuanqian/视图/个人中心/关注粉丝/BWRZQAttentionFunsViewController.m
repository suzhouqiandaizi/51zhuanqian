...
@interface BWRZQAttentionFunsViewController ()<SGPageTitleViewDelegate, SGPageContentViewDelegate>
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentView *pageContentView;
@end
@implementation BWRZQAttentionFunsViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self addBackBtn];
    [self setupPageView];
...
- (void)setupPageView {
    ...
    for (NSInteger i = 0; i < arrayID.count ; i++) {
        BWRZQAttentionFunsDetailViewController *viewCon = [[BWRZQAttentionFunsDetailViewController alloc] initWithNibName:@"BWRZQAttentionFunsDetailViewController" bundle:nil];
