...
@interface WYZQAttentionFunsDetailViewController (){
    NSInteger                  pageNum;
    NSInteger                  pageSize;
...
@end
@implementation WYZQAttentionFunsDetailViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    pageNum = 1;
    pageSize = 15;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    WYZQAttentionFunsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"WYZQAttentionFunsTableViewCell" owner:self options:nil] lastObject];
