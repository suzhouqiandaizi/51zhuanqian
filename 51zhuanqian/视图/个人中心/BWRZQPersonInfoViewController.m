...
@interface BWRZQPersonInfoViewController ()<UINavigationControllerDelegate, UIActionSheetDelegate,  UIImagePickerControllerDelegate>
@property (weak, nonatomic) IBOutlet UIView *topView;
@property (weak, nonatomic) IBOutlet UIImageView *headerImageView;
@property (weak, nonatomic) IBOutlet UILabel *nameLabel;
@end
@implementation BWRZQPersonInfoViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"账户信息";
    [self addBackBtn];
...
- (IBAction)namePress {
    BWRZQPersonEditViewController *viewCon = [[BWRZQPersonEditViewController alloc] initWithNibName:@"BWRZQPersonEditViewController" bundle:nil];
