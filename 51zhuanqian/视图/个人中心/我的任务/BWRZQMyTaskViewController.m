...
@interface BWRZQMyTaskViewController ()<SGPageTitleViewDelegate, SGPageContentViewDelegate>{
}
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentView *pageContentView;
@end
@implementation BWRZQMyTaskViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"我的任务";
    [self addBackBtn];
...
- (void)setupPageView {
    ...
    for (NSInteger i = 0; i < arrayID.count ; i++) {
        BWRZQMyTaskItemViewController *viewCon = [[BWRZQMyTaskItemViewController alloc] initWithNibName:@"BWRZQMyTaskItemViewController" bundle:nil];
