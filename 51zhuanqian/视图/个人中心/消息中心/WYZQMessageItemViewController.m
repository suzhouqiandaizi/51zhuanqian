...
@interface WYZQMessageItemViewController (){
    NSInteger                  pageNum;
    NSInteger                  pageSize;
...
@end
@implementation WYZQMessageItemViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    pageNum = 1;
    pageSize = 15;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    WYZQMessageTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"WYZQMessageTableViewCell" owner:self options:nil] lastObject];
