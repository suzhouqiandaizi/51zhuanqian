...
@interface BWRZQInputJiaoyiMimaViewController ()
@property (nonatomic, strong) SHPasswordTextView *passwordTextView;
@property (weak, nonatomic) IBOutlet UIScrollView *scrollView;
@property (weak, nonatomic) IBOutlet UIView *contentView;
@end
@implementation BWRZQInputJiaoyiMimaViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"验证交易密码";
    [self addBackBtn];
...
- (IBAction)wangjimimaPress {
    BWRZQYanzhengShoujiViewController *viewCon = [[BWRZQYanzhengShoujiViewController alloc] initWithNibName:@"BWRZQYanzhengShoujiViewController" bundle:nil];
