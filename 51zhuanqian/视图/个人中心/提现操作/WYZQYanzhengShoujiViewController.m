...
@interface WYZQYanzhengShoujiViewController ()
...
@end
@implementation WYZQYanzhengShoujiViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"验证手机号";
    [self addBackBtn];
...
- (IBAction)surePress {
    ...
    [[ServiceRequest sharedService] GET:@"user/sms-code" parameters:dic success:^(id responseObject) {
        [self hideHudAlert];
        WYZQChangeJiaoYiViewController *viewCon = [[WYZQChangeJiaoYiViewController alloc] initWithNibName:@"WYZQChangeJiaoYiViewController" bundle:nil];
        viewCon.popNumber = 2;
