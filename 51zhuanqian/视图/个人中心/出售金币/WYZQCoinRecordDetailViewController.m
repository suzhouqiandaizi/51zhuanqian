...
@interface WYZQCoinRecordDetailViewController ()<SGPageTitleViewDelegate, SGPageContentViewDelegate>
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentView *pageContentView;
@end
@implementation WYZQCoinRecordDetailViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)setupPageView {
    ...
    for (NSInteger i = 0; i < arrayID.count ; i++) {
        WYZQCoinRecordViewController *viewCon = [[WYZQCoinRecordViewController alloc] initWithNibName:@"WYZQCoinRecordViewController" bundle:nil];
