...
@interface WYZQTaskFabuViewController ()<SGPageTitleViewDelegate, SGPageContentViewDelegate>
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentView *pageContentView;
@end
@implementation WYZQTaskFabuViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"我发布的任务";
    [self addBackBtn];
...
- (void)setupPageView {
    ...
    for (NSInteger i = 0; i < arrayID.count ; i++) {
        WYZQTaskFabuItemViewController *viewCon = [[WYZQTaskFabuItemViewController alloc] initWithNibName:@"WYZQTaskFabuItemViewController" bundle:nil];
        viewCon.type = i;
