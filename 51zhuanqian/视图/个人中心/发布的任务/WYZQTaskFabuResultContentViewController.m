...
@interface WYZQTaskFabuResultContentViewController ()<SGPageTitleViewDelegate, SGPageContentViewDelegate>
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentView *pageContentView;
@end
@implementation WYZQTaskFabuResultContentViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self setupPageView];
}
...
- (void)setupPageView {
    ...
    for (NSInteger i = 0; i < 3 ; i++) {
        WYZQTaskFabuResultViewController *viewCon = [[WYZQTaskFabuResultViewController alloc] initWithNibName:@"WYZQTaskFabuResultViewController" bundle:nil];
