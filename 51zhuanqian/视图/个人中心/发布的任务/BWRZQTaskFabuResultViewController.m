...
@interface BWRZQTaskFabuResultViewController ()<MIPhotoBrowserDelegate>{
...
@end
@implementation BWRZQTaskFabuResultViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    pageNum = 1;
    pageSize = 15;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BWRZQTaskFabuResultTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"BWRZQTaskFabuResultTableViewCell" owner:self options:nil] lastObject];
