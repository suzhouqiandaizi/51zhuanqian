...
@interface WYZQPersonViewController ()<SRRefreshDelegate>{
...
@end
@implementation WYZQPersonViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"我";
...
- (void)settingPress {
    WYZQSettingViewController *viewCon = [[WYZQSettingViewController alloc] initWithNibName:@"WYZQSettingViewController" bundle:nil];
...
- (IBAction)tixianPress {
    ...
    [[ServiceRequest sharedService] GET:[NSString stringWithFormat:@"user/%@/account-info", user.userID] parameters:nil success:^(id responseObject) {
        ...
        if (accountStr.length > 0) {
            WYZQTixianAgainViewController *viewCon = [[WYZQTixianAgainViewController alloc] initWithNibName:@"WYZQTixianAgainViewController" bundle:nil];
...
- (IBAction)saleCoinPress {
    WYZQSaleCoinViewController *viewCon = [[WYZQSaleCoinViewController alloc] initWithNibName:@"WYZQSaleCoinViewController" bundle:nil];
    [self.navigationController pushViewController:viewCon animated:YES];
}
- (IBAction)cashRecordPress {
    WYZQCoinRecordDetailViewController *viewCon = [[WYZQCoinRecordDetailViewController alloc] initWithNibName:@"WYZQCoinRecordDetailViewController" bundle:nil];
...
- (IBAction)messagePress {
    WYZQMessageViewController *viewCon = [[WYZQMessageViewController alloc] initWithNibName:@"WYZQMessageViewController" bundle:nil];
    viewCon.taskNumDic = taskNumDic;
    [self.navigationController pushViewController:viewCon animated:YES];
}
- (IBAction)taskDoingPress:(id)sender {
    WYZQTaskDoingViewController *viewCon = [[WYZQTaskDoingViewController alloc] initWithNibName:@"WYZQTaskDoingViewController" bundle:nil];
...
- (IBAction)fabuPress:(id)sender {
    WYZQTaskFabuViewController *viewCon = [[WYZQTaskFabuViewController alloc] initWithNibName:@"WYZQTaskFabuViewController" bundle:nil];
    UIButton *btn = (UIButton *)sender;
    viewCon.taskNumDic = taskNumDic;
...
- (IBAction)zhanghuPress {
    WYZQPersonInfoViewController *viewCon = [[WYZQPersonInfoViewController alloc] initWithNibName:@"WYZQPersonInfoViewController" bundle:nil];
    [self.navigationController pushViewController:viewCon animated:YES];
}
- (void)guanzhuPress:(UIGestureRecognizer *)gesture{
    WYZQAttentionFunsViewController *viewCon = [[WYZQAttentionFunsViewController alloc] initWithNibName:@"WYZQAttentionFunsViewController" bundle:nil];
