...
@interface BWRZQBlacklistViewController (){
    NSInteger                  pageNum;
    NSInteger                  pageSize;
...
@end
@implementation BWRZQBlacklistViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"黑名单管理";
    [self addBackBtn];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BWRZQBlacklistTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"BWRZQBlacklistTableViewCell" owner:self options:nil] lastObject];
