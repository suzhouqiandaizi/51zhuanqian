...
#import "MJRefresh.h"
@interface WYZQShouTuDetailViewController (){
...
@end
@implementation WYZQShouTuDetailViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"收徒明细";
    [self addBackBtn];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    WYZQShouTuDetailTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"WYZQShouTuDetailTableViewCell" owner:self options:nil] lastObject];
