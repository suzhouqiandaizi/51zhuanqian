...
@interface WYZQTuiGuangViewController (){
...
@end
@implementation WYZQTuiGuangViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"推广";
...
- (IBAction)shoutuDetailPress {
    WYZQShouTuDetailViewController *viewCon = [[WYZQShouTuDetailViewController alloc] initWithNibName:@"WYZQShouTuDetailViewController" bundle:nil];
    [self.navigationController pushViewController:viewCon animated:YES];
}
- (void)requestContent{
    UserInfo *user = [UserManger currentLoggedInUser];
