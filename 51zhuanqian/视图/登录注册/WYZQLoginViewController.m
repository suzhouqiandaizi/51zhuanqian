...
@interface WYZQLoginViewController ()<UINavigationControllerDelegate>{
    BOOL    hasLogin;
}
...
@end
@implementation WYZQLoginViewController
...
- (void)viewDidLoad {
    ...
    if (![DEFAULTS boolForKey:@"SHOWPRIVACYPROTOCOL"]) {
        WYZQLoginPrivacyProtocolView *alertView = [[WYZQLoginPrivacyProtocolView alloc] initItem];
...
- (IBAction)meishoudaoyanzhengmaPress {
    WYZQLoginAlertView *alertView = [[WYZQLoginAlertView alloc] initItem];
    [self.view.window addSubview:alertView];
}
- (IBAction)qiehuanPress {
    WYZQLoginPasswordViewController *viewCon = [[WYZQLoginPasswordViewController alloc] initWithNibName:@"WYZQLoginPasswordViewController" bundle:nil];
