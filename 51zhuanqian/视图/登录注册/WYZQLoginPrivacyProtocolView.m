...
@interface WYZQLoginPrivacyProtocolView()
@property (weak, nonatomic) IBOutlet UIView *showView;
@property (weak, nonatomic) IBOutlet UITextView *textView;
@property (weak, nonatomic) IBOutlet UILabel *infoLabel;
@end
@implementation WYZQLoginPrivacyProtocolView
- (id)initItem{
    self = [[[NSBundle mainBundle] loadNibNamed:@"WYZQLoginPrivacyProtocolView" owner:self options:nil] lastObject];
    if (self) {
