...
#import "LoadConfig.h"
@interface WYZQLoginAlertView()
@property (weak, nonatomic) IBOutlet UIView *showView;
@property (weak, nonatomic) IBOutlet UITextView *contentTextView;
@end
@implementation WYZQLoginAlertView
- (id)initItem{
    self = [[[NSBundle mainBundle] loadNibNamed:@"WYZQLoginAlertView" owner:self options:nil] lastObject];
    if (self) {
