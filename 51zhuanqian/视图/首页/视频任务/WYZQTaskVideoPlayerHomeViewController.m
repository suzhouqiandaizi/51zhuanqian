...
@interface WYZQTaskVideoPlayerHomeViewController ()<SGPageTitleViewDelegate, SGPageContentViewDelegate>
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentView *pageContentView;
@end
@implementation WYZQTaskVideoPlayerHomeViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self addBackBtn];
...
- (void)setupPageView:(NSArray *)arr {
    ...
    for (NSInteger i = 0; i < contentArr.count ; i++) {
        WYZQTaskVideoPlayerItemViewController *viewCon = [[WYZQTaskVideoPlayerItemViewController alloc] initWithNibName:@"WYZQTaskVideoPlayerItemViewController" bundle:nil];
