...
@interface WYZQTaskVideoPlayerViewController ()<UINavigationControllerDelegate>{
...
@end
@implementation WYZQTaskVideoPlayerViewController
...
- (void)showContentPlayer:(NSDictionary *)dic{
    __weak WYZQTaskVideoPlayerViewController *viewCon = self;
