...
@interface WYZQBaiduRewardVideoViewController ()<UINavigationControllerDelegate, BaiduMobAdRewardVideoDelegate>
@property (nonatomic, strong) BaiduMobAdRewardVideo *reward;
@end
@implementation WYZQBaiduRewardVideoViewController
