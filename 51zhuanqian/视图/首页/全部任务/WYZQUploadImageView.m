...
@interface WYZQUploadImageView()<UINavigationControllerDelegate, UIActionSheetDelegate,  UIImagePickerControllerDelegate, MIPhotoBrowserDelegate>{
}
@property (weak, nonatomic) IBOutlet UIButton *removeBtn;
@end
@implementation WYZQUploadImageView
- (id)initItem:(CGRect)frame{
    self = [[[NSBundle mainBundle] loadNibNamed:@"WYZQUploadImageView" owner:self options:nil] lastObject];
    if (self) {
        [self setFrame:frame];
