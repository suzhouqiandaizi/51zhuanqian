...
@interface BWRZQTaskClassifyView()<UICollectionViewDelegate, UICollectionViewDataSource, UITableViewDelegate, UITableViewDataSource>{
...
@end
@implementation BWRZQTaskClassifyView
- (id)initItem{
    self = [[[NSBundle mainBundle] loadNibNamed:@"BWRZQTaskClassifyView" owner:self options:nil] lastObject];
    if (self) {
...
- (void)configCollectionView:(NSArray *)arr {
    ...
    [self.collectionView registerClass:[BWRZQFaBuChooseTypeCollectionViewCell class] forCellWithReuseIdentifier:@"FaBuChooseTypeCell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BWRZQFaBuChooseTypeCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:CellIdentifier forIndexPath:indexPath];
    ...
    cell.RefreshHandle = ^(BWRZQFaBuChooseTypeCollectionViewCell  *chooseCell) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BWRZQTaskClassifyTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"BWRZQTaskClassifyTableViewCell" owner:self options:nil] lastObject];
    ...
    cell.indexRow = indexPath.row;
    cell.RefreshHandle = ^(BWRZQTaskClassifyTableViewCell  *chooseCell) {
