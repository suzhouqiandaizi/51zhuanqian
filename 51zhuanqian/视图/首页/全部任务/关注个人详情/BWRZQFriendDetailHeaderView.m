...
@interface BWRZQFriendDetailHeaderView(){
...
@end
@implementation BWRZQFriendDetailHeaderView
- (id)initItem{
    self = [[[NSBundle mainBundle] loadNibNamed:@"BWRZQFriendDetailHeaderView" owner:self options:nil] lastObject];
    if (self) {
