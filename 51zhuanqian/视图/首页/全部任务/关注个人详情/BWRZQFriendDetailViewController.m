...
@interface BWRZQFriendDetailViewController ()<UINavigationControllerDelegate>{
    BWRZQFriendDetailHeaderView *headerView;
...
@end
@implementation BWRZQFriendDetailViewController
...
- (void)viewDidLoad {
    ...
    headerView = [[BWRZQFriendDetailHeaderView alloc] initItem];
    __block BWRZQFriendDetailViewController *viewCon = self;
