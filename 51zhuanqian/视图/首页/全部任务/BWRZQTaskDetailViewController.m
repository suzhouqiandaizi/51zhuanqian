...
@interface BWRZQTaskDetailViewController ()<UINavigationControllerDelegate,WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler>{
}
...
@end
@implementation BWRZQTaskDetailViewController
