...
#import "LoadConfig.h"
@interface WYZQAllTaskViewController ()<SGPageTitleViewDelegate, SGPageContentViewDelegate>{
}
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentView *pageContentView;
@end
@implementation WYZQAllTaskViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"任务";
    [self addBackBtn];
...
- (void)setupPageView {
    ...
    for (NSInteger i = 0; i < contentArr.count ; i++) {
        WYZQTaskItemViewController *viewCon = [[WYZQTaskItemViewController alloc] initWithNibName:@"WYZQTaskItemViewController" bundle:nil];
