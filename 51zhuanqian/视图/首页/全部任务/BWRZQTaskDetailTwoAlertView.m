...
@interface BWRZQTaskDetailTwoAlertView()
@property (weak, nonatomic) IBOutlet UIView *showView;
@property (weak, nonatomic) IBOutlet UIButton *sureBtn;
@property (weak, nonatomic) IBOutlet UILabel *contentLabel;
@end
@implementation BWRZQTaskDetailTwoAlertView
- (id)initItem{
    self = [[[NSBundle mainBundle] loadNibNamed:@"BWRZQTaskDetailTwoAlertView" owner:self options:nil] lastObject];
    if (self) {
