...
#import "ShareView.h"
@interface WYZQTaskReadViewController ()<UIScrollViewDelegate,UINavigationControllerDelegate,WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler>{
    NSInteger       count;
    float           readTimeNum;
...
@end
@implementation WYZQTaskReadViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self addBackBtn];
