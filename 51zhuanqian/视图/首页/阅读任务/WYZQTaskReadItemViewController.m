...
@interface WYZQTaskReadItemViewController (){
...
@end
@implementation WYZQTaskReadItemViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    pageNum = 1;
    pageSize = 15;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[dic objectForKey:@"taskThumbs"] count] > 1) {
        ...
        WYZQTaskReadItemOneTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
        if (!cell) {
            cell = [[[NSBundle mainBundle] loadNibNamed:@"WYZQTaskReadItemOneTableViewCell" owner:self options:nil] lastObject];
        ...
        WYZQTaskReadItemTwoTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
        if (!cell) {
            cell = [[[NSBundle mainBundle] loadNibNamed:@"WYZQTaskReadItemTwoTableViewCell" owner:self options:nil] lastObject];
            cell.selectionStyle = UITableViewCellSelectionStyleNone;
        }
        cell.titleLabel.text = [dic objectForKey:@"taskTitle"];
        cell.bottomLabel.text = [NSString stringWithFormat:@"%@   %@", [dic objectForKey:@"fromChannel"], [dic objectForKey:@"createTime"]];
