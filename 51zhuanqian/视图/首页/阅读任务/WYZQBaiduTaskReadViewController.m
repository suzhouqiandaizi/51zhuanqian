...
@interface WYZQBaiduTaskReadViewController ()<UIScrollViewDelegate,UINavigationControllerDelegate,WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler>{
    NSInteger       count;
...
@end
@implementation WYZQBaiduTaskReadViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self addBackBtn];
