...
@interface BWRZQTaskReadHomeViewController ()<SGPageTitleViewDelegate, SGPageContentViewDelegate>
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentView *pageContentView;
@end
@implementation BWRZQTaskReadHomeViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self addBackBtn];
...
- (void)setupPageView:(NSArray *)arr {
    ...
    for (NSInteger i = 0; i < contentArr.count ; i++) {
        BWRZQTaskReadItemViewController *viewCon = [[BWRZQTaskReadItemViewController alloc] initWithNibName:@"BWRZQTaskReadItemViewController" bundle:nil];
