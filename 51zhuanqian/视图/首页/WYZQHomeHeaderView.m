...
@interface WYZQHomeHeaderView()<SDCycleScrollViewDelegate>{
    NSArray             *bannerArr;
}
@end
@implementation WYZQHomeHeaderView
- (id)initItem{
    self = [[[NSBundle mainBundle] loadNibNamed:@"WYZQHomeHeaderView" owner:self options:nil] lastObject];
    if (self) {
        ...
        for (int i = 0; i < taskArr.count; i++) {
            ...
            if ([[taskCategoryDic objectForKey:@"displayType"] isEqualToString:@"分类"]) {
                ...
                for (int j = 0; j < taskCategoryArr.count; j++) {
                    ...
                    WYZQHomeTaskOneView *taskOneView = [[WYZQHomeTaskOneView alloc] initItem:CGRectMake(taskOneViewOriginX, viewOriginY, taskOneViewWidth, 77)];
                ...
                for (int j = 0; j < taskCategoryArr.count; j++) {
                    ...
                    WYZQHomeTaskTwoView *taskTwoView = [[WYZQHomeTaskTwoView alloc] initItem:CGRectMake(taskTwoViewOriginX, viewOriginY, taskTwoViewWidth, 112)];
                ...
                for (int j = 0; j < taskCategoryArr.count; j++) {
                    ...
                    WYZQHomeTaskThreeView *taskThreeView = [[WYZQHomeTaskThreeView alloc] initItem:CGRectMake(taskOneViewOriginX, viewOriginY, taskOneViewWidth, 60)];
